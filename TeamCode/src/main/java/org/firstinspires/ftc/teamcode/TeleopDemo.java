...
//
            ...
            if (drive) {
                 ...
                 mecanumRobotCentricDrive(-gamepad1.right_stick_y, gamepad1.right_stick_x, gamepad1.left_stick_x);
            }
...

    {
       ...
       if(Math.abs(x)>0.1){
           ...
           turnPower = rbg.turretdemo(outtakestate,  turretPos, limeValid, Tx);
